...
$validator->addValidation("user_name","required","Please fill in username");
$validator->addValidation("user_name","alnum","The input for username should be a valid alpha-numeric value");
$validator->addValidation("user_name","unique","This value is already submitted");
$validator->addValidation("user_name","maxlen=30","The length of the input for username should not exceed 30");
$validator->addValidation("user_name","minlen=8","The length of the input for username should be at least 8.");
...
$validator->addValidation("password","eqelmnt=cpassword","password do not match");
$validator->addValidation("cpassword","required","Please fill in confirm password");
$validator->addValidation("cpassword","alnum","The input for confirm password should be a valid alpha-numeric value");
$validator->addValidation("cpassword","maxlen=30","The length of the input for confirm password should not exceed 30");
$validator->addValidation("cpassword","minlen=8","The length of the input for confirm password should be at least 8.");
