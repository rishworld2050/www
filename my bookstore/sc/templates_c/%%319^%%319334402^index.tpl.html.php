 ...
 <tr>
  ...
  <tr style="background: url(images/abc.png) repeat-x; height:180px;">
    <td valign="middle" width="10%">
		<a href="http://localhost/my bookstore/sc/"><img src="images/bookstore.png" border="0" alt="<?php echo @constant('CONF_SHOP_NAME'); ?>
" hspace="100px"></a>
	</td>
	<td valign="middle" width="90%" align="right">
				<table id="tabnav" border="0" cellspacing="10px" cellpadding="0">
					<tr valign="middle" align="right"> 
					  ...
					  <td><a href="http://localhost/my bookstore/sc/book/index.html" class="menu">Home</a></div></td>
					  <td>&nbsp;</td>
					  <td><a href="http://localhost/my bookstore/sc/book/portfolio.html" class="menu">Gallery</a></div></td>
					  <td>&nbsp;</td>
					  <td><a href="http://localhost/my bookstore/sc/book/blog_post.html" class="menu">Discussion</a></div></td>
					  <td>&nbsp;</td>
					  <td><a href="http://localhost/my bookstore/sc/book/forms/contact/Contact Us.php" class="menu">Contact Us</a></div></td>
					   <td><a href="http://localhost/my bookstore/sc/book/login.php" class="menu">Register/Login</a></div></td>
					  <td>&nbsp;</td>
					   <td><a href="http://localhost/my bookstore/sc/" class="menu">Shopping</a></div></td>
					  <td>&nbsp;</td>
					</tr>
				</table>
	</td>
