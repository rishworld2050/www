...
class FGMembersite
{
    ...
    function CheckLoginInDB($username,$password)
    {
        ...
        $qry = "Select user_name, email from $this->tablename where user_name='$username' and password='$pwdmd5'";
    ...
    function ChangePasswordInDB($user_rec, $newpwd)
    {
        ...
        $qry = "Update $this->tablename Set password='".$newpwd."' Where  ID='".$user_rec['ID']."'";
