...
CREATE TABLE IF NOT EXISTS `mc_sales` (
  ...
  `couponTotal` varchar(100) NOT NULL DEFAULT '0',
  `subTotal` varchar(20) NOT NULL DEFAULT '0',
  `grandTotal` varchar(20) NOT NULL DEFAULT '0',
  `shipTotal` varchar(20) NOT NULL DEFAULT '0',
