...
*/
include dirname(__FILE__) . '/Savant3/Filter.php';
include dirname(__FILE__) . '/Savant3/Plugin.php';
		...
		$trace = true)
	{
		...
		if ($this->__config['exceptions']) {
			if (! class_exists('Savant3_Exception', $autoload)) {
				include dirname(__FILE__) . '/Savant3/Exception.php';
			}
		...
		if (! class_exists('Savant3_Error', $autoload)) {
			include dirname(__FILE__) . '/Savant3/Error.php';
		}
