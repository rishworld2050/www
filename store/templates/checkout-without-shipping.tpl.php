      <?php
      /*
        CHECKOUT ROUTINES WITHOUT SHIPPINGS
      ...
      */
      ...
      if ($this->CART_COUNT>0) {
      ?>
      <div class="notesWrapper" id="notesWrapper" style="display:block">
      ...
      ?>
      <div id="loadBlock" style="display:block">
      ...
      ?>
      <p class="empty_basket_img"><img src="templates/images/nothing.png" alt="<?php echo $this->TEXT[5]; ?>" title="<?php echo $this->TEXT[5]; ?>" /></p>
