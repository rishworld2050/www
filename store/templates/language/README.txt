...
The .php files in the 'templates/language/english/' directory are languages files for the Maian Cart script. Edit them to suit your own preferences.
...
The e-mail templates are located in the 'templates/language/english/email-templates/' directory. Again, do NOT remove any system variables between braces. ie: {NAME}
...
If you can`t find a particular variable, use a good search utility to find the language you are looking for and search the 'templates/language/english/' directory. 
